    ...
    const logos = [
        {
            ...
            description: <div>
                ...
                • Spearheaded the modernization of Axiell&apos;s Vital Records Management System, leveraging expertise in microservices architecture, domain-driven design, and event-driven systems<br/>
        ...
        },
        {
            ...
            description: <div>
                ...
                Senior Software Engineer<br/><br/>
                • Architected and developed key components of the Oceania Cruises e-commerce platform using a modern tech stack (Vue.js, Angular, C#, Scala)<br/>
        ...
        },
        {
            ...
            description: <div>
                ...
                Senior Software Engineer<br/><br/>
                • Assisted the integration of Salesforce with the existing platform, utilizing Salesforce APIs and custom middleware (Node.js, Express.js) to seamlessly exchange data<br/>
        ...
        },
        {
            ...
            description: <div>
                ...
                • Implemented a feature flagging system to enable controlled rollouts and A/B testing of new features<br/>
        ...
        },
        {
            ...
            description: <div>
                ...
                Senior Software Engineer<br/><br/>
                • Contributed for the development of the Guided Selling Tool using React, Redux, and Node.js, collaborating closely with product managers and UX designers to deliver an intuitive, data-driven user experience<br/>
                • Designed and implemented a unified API gateway using GraphQL to facilitate the integration of backend systems during the Sprint and T-Mobile merger<br/>
                • Implemented a robust error tracking and monitoring system to proactively identify and resolve production issues<br/>
