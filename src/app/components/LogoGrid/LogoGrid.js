...
const logos = [
    {
        ...
        description: <div>
            ...
            ▪ Led the internationalization effort, adapting the system for the Canadian market and ensuring compliance with local regulations and standards.<br/>
            ▪ Integrated AI-based data analytics tools to provide predictive insights and enhance decision-making processes.<br/><br/>
        </div>
    },
    {
        id: 2,
        ...
        description: <div>
            ...
            ▪ Conducted code reviews, provided technical guidance, and mentored junior developers to maintain high code quality and adherence to best practices.<br/>
            ▪ Developed and deployed machine learning models to personalize user experiences and improve customer satisfaction.<br/><br/>
        </div>
    },
    {
        id: 3,
        ...
        description: <div>
            ...
            ▪ Optimized application performance by implementing server-side rendering (Next.js), lazy loading, and code splitting techniques.<br/>
            ▪ Applied AI algorithms to analyze user data and provide targeted content and recommendations.<br/><br/>
        </div>
    },
    {
        id: 4,
        ...
        description: <div>
            ...
            ▪ Conducted workshops and training sessions on Agile methodologies, CI/CD best practices, and microservices architecture for the development team.<br/>
            ▪ Utilized machine learning techniques to optimize data processing workflows and improve system performance.<br/><br/>
        </div>
    },
    {
        id: 5,
        ...
        description: <div>
            ...
            Software Engineer<br/><br/>
            ▪ Contributed to the development of the Guided Selling Tool using React, Redux, and Node.js, collaborating closely with product managers and UX designers to deliver an intuitive, data-driven user experience.<br/>
            ...
            ▪ Mentored junior developers and conducted code reviews to ensure adherence to coding standards, design patterns, and best practices.<br/>
            ▪ Developed predictive algorithms to enhance product recommendations and drive sales.<br/><br/>
        </div>
    },
    {
        id: 6,
    ...
    },
    {
        ...
        description: <div>
            ...
            ▪ Collaborated with cross-functional teams using Agile methodologies (Scrum, Kanban) to gather requirements and deliver high-quality solutions.<br/>
            ▪ Applied data analytics and machine learning techniques to improve customer segmentation and targeting.<br/><br/>
        </div>
    },
];
